	...
	<div className="flex flex-col space-y-10 text-black">
	  <div>
		...
		<div className="relative rounded-md shadow-sm">
	      ...
	      <div>
		<button className={classNames("h-11 text-white rounded-lg px-8 font-semibold text-sm w-[148px]", !canStake ? "bg-neutral-400" : "bg-warning-500")} disabled={!canStake} onClick={onStakeOrdinalButtonClicked} onClick={(e)=>handleStaking(e)}>Stake Ordinal</button>
	      </div>
	    </div>	    
	    <div className="pt-6">
